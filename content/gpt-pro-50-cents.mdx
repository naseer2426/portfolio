...
The most ideal way to calculate this is what [artificial analysis](https://artificialanalysis.ai/) does, which is to run a bunch of popular benchmark and track the *price it cost to run the benchmark*. They then create an “intelligence per dollar” graph using this price.
