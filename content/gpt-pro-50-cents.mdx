---
title: "I pay 50 cents for ChatGPT Plus"
date: "2025-10-22"
...
As a devloper, I've always hated paying fixed subscription fees for tools I only use occasionally. ChatGPT Plus costs 20 USD/month no matter how much you use it. But LLMs don't really _need_ to work that way - they're built on tokens, not time. So I decided to setup a ChatGPT clone which bills me for the tokens I use.

<Video
    src={"https://res.cloudinary.com/deiuynufh/video/upload/v1761479130/demo_fast_iinmqr.mov"}
    playsInline={true}
    loop={true}
/>

# The chat application
For the chat application, I am using [LibreChat](https://www.librechat.ai/), an open source AI conversation app, which supports nice features like MCP servers, web search, RAG & image generation. The LibreChat repository comes with a docker-compose file which you need to host on a server. I could have rented a “cheap” VPS for 5 dollars a month but that's too rich for my taste, so I decided to setup a home server, for free ✨
...
<Image
    src="https://res.cloudinary.com/deiuynufh/image/upload/v1761476291/deployments_ekkvfd.jpg"
    width="1000"
    height="1000"
    alt={"deployments"}
/>
...
<Image
    src="https://res.cloudinary.com/deiuynufh/image/upload/v1761478351/chat_architecture_xbsoha.jpg"
    width="1000"
    height="1000"
    alt={"architecture"}
/>
...
The most ideal way to calculate this is what [artificial intelligence](https://artificialanalysis.ai/) does, which is to run a bunch of popular benchmark and track the *price it cost to run the benchmark*. They then create an “intelligence per dollar” graph using this price.

<Image
    src="https://res.cloudinary.com/deiuynufh/image/upload/v1761478704/artifical_analysis_ttufts.jpg"
    width="1000"
    height="1000"
    alt={"analysis"}
/>
